# OilMate — ผู้ช่วยงานหล่อลื่น GC-M PTA

เว็บแอปค้นหาอุปกรณ์และสารหล่อลื่นสำหรับโรงงาน GC-M PTA รวมข้อมูลจาก 3 แผนก (ME/EE/IE) เข้าเป็นระบบค้นหาเดียว รองรับการค้นหาด้วย EQ Tag หรือคำทั่วไป (เช่น "Compressor", "Pump") พร้อมให้คะแนนความตรงของผลลัพธ์
